...
static void         cache_insert_value      (const gchar      *table_name,
                                             ...
                                             gboolean          fts,
                                             gboolean          date_time);
static void         cache_update_value      (const gchar      *table_name,
                                             const gchar      *field_name,
                                             gboolean          transient,
                                             GValue           *value,
                                             gint              graph,
...
static void
cache_update_value (const gchar            *table_name,
                    const gchar            *field_name,
                    gboolean                transient,
                    GValue                 *value,
                    gint                    graph,
	...
	if (!multiple_values) {
		...
		while (*domain_index_classes) {
			if (resource_in_domain_index_class (*domain_index_classes)) {
				...
				cache_update_value (tracker_class_get_name (*domain_index_classes),
				                    field_name,
				                    tracker_property_get_transient (property),
				                    &gvalue_copy,
				                    graph != NULL ? ensure_resource_id (graph, NULL) : graph_id,
